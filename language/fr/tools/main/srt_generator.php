...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	'STEP1_MOD'				=> 'Le problème est-il lié à un MOD ?',
	'STEP1_MOD_EXPLAIN'		=> 'Le problème a-t-il commencé après l’installation ou la suppression d’un MOD ?',
	'STEP1_MOD_ERROR'		=> 'Les demandes de support pour des problèmes liés aux MODs (par exemple, si un MOD vient d’être installé et que des erreurs sont constatées) doivent être postées dans le sujet où le MOD a été téléchargé. Si le MOD est issu d’un autre forum, Merci de s’adresser à celui-ci.<br /><br />Se rendre dans les <a href="http://www.phpbb.com/community/viewforum.php?f=451">forums de support des extensions pour phpBB.com</a> ou les <a href="http://forums.phpbb-fr.com/support-des-extensions/">forums de support des extensions pour phpBB-fr.com</a>.',
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS'	=> array(
		'step2'	=> array(
			...
			'mods_installed'	=> 'Des MODs sont-ils installés ?',
		...
		'step3'	=> array(
			...
			'installed_mods'		=> 'Quels MODs ont été installés ?',
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS_EXPLAIN'	=> array(
		'step2'	=> array(
			...
			'dbms'				=> 'Pour déterminer la version et le type de la base de données utilisée, se rendre dans le « Panneau de Contrôle d’Administration (ACP) », onglet « Général », chercher « Serveur de base de données » dans « Statistiques du forum ».',
			'php'				=> 'Pour déterminer la version de PHP utilisée, se rendre dans le « Panneau de Contrôle d’Administration (ACP) », onglet « Général », cliquer sur  « Informations PHP » dans « Accès rapide » et chercher « PHP Version x.y.z ».',
			...
			'mods_installed'	=> 'Les Mods sont souvent la cause de nombreux problèmes avec phpBB. Cette information peut aider à déterminer la cause exacte du problème.',
			'registration_req'	=> 'Sélectionner « Oui » si l’on doit être inscrit et connecté pour voir le problème.',
		),
		'step3'	=> array(
			'installed_styles'		=> 'Les anciens styles sont souvent la cause de nombreux problèmes. Si les styles installés sont inconnus, se rendre dans le Panneau de Contrôle d’Administration (ACP) et cliquer sur l’onglet « Styles ».',
			'installed_languages'	=> 'Les anciens packs de langue sont souvent la cause de nombreux problèmes. Si les packs de langue installés sont inconnus, se rendre dans le Panneau de Contrôle d’Administration (ACP), onglet « Système », « Tâches générales » et cliquer sur « Langues » dans la liste de gauche.',
			'xp_level'				=> 'Merci de sélectionner l’option qui décrit le mieux ses compétences en matière d’utilisation de phpBB.',
			'problem_started'		=> 'Merci d’indiquer les actions effectuées (mise à jour de son forum, installation de MODs, etc.) avant que le problème ne devienne perceptible.',
			...
			'installed_mods'		=> 'Merci d’être le plus précis possible en indiquant les MODs installés. Cette information contribue beaucoup à nous aider pour déterminer la cause du problème.',
