...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	'STEP1_MOD'				=> 'Is your problem extensions related?',
	'STEP1_MOD_EXPLAIN'		=> 'Did this problem start after installing or removing a extension?',
	'STEP1_MOD_ERROR'		=> 'Support questions for extensions related issues (e.g., if you have just installed a MOD and are now getting errors) should be posted within the topic of where you have downloaded the MOD. If the MOD was downloaded from another site you will have to seek support there.<br /><br /><a href="https://www.phpbb.com/community/viewforum.php?f=451">Go to the Support Forums</a>',
