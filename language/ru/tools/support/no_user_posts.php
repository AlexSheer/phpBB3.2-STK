...
$lang = array_merge($lang, array(
	...
	'NO_USER_POSTS_EXPLAIN'			=> 'Этот инструмент позволяет удалить сообщения несуществующих авторов или назначить авторов для этих сообщений (это может произойти в случае, если пользователи были удалены вручную непосредственно из базы данных, а не штатными средствами phpBB).',
