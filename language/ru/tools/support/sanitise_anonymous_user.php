...
$lang = array_merge($lang, array(
	...
	'ANONYMOUS_CREATION_FAILED'			=> 'Невозможно пересоздать учётную запись гостя. Обратитесь за поддержкой на <a href="https://www.phpbbguru.net/community">официальный сайт поддержки phpBB3</a>',
