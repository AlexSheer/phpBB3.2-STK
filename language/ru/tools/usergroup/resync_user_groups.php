...
$lang = array_merge($lang, array(
	...
	'RUN_RNR_EXPLAIN'				=> 'Эта проверка приведет к возвращению в группу Зарегистрированные пользователи всех пользователей, которые соответствуют критериям этой группе.',
