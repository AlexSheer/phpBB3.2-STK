...
$lang = array_merge($lang, array(
	...
	'FOUNDERS'					=> 'Пользователи со статусом Основателя',

	'MAKE_FOUNDER'				=> 'Присвоить пользователю статус Основателя',
	'MAKE_FOUNDER_CONFIRM'		=> 'Вы уверены, что хотите сделать <a href="%1$s">%2$s</a> Основателем? Это даст <a href="%1$s">%2$s</a> возможность удалить вашу учётную запись.',
	...
	'USER_NAME_TO_FOUNDER_EXPLAIN'	=> 'Введите имя пользователя, которому вы хотите присвоить статус Основателя.',
	'USER_ID_TO_FOUNDER'			=> 'ID пользователя, которому необходимо присвоить статус Основателя',
	'USER_ID_TO_FOUNDER_EXPLAIN'	=> 'Введите ID пользователя, которому вы хотите присвоить статус Основателя.',
));
