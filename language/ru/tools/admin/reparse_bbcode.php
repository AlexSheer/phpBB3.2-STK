...
$lang = array_merge($lang, array(
	...
	'REPARSE_SIG'					=> 'Провести репарсинг только подписей пользователей',
	'REPARSE_SIG_EXPLAIN'			=> 'Если отмечено, будет произведён репарсинг BBCode только в подписях пользователей.',
