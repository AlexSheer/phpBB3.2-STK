...
$lang = array_merge($lang, array(
	...
	'CAT_USERGROUP_EXPLAIN'				=> 'Средства пользователи и группы могут быть использованы для управления пользователями и группами, такими способами, которые не доступны в стандартной установке phpBB 3.2.x.',
