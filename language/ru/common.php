...
$lang = array_merge($lang, array(
	...
	'CAT_MAIN'							=> 'Главная',
	'CAT_MAIN_EXPLAIN'					=> 'Support Toolkit, или STK представляет собой программный пакет, который может быть использован для устранения проблем, связанных с работой phpBB 3.2.x/3.3.x. Инструментарий является второй <b>Администраторской панелью управления</b>, предоставляющей администратору доступ к функциям, используемым для разрешения различных проблем неправильной работы конференции.',
	'CAT_SUPPORT'						=> 'Инструменты поддержки',
	'CAT_SUPPORT_EXPLAIN'				=> 'Средства поддержки используются для фиксации проблем или восстановления отдельных частей установки phpBB 3.2.x/3.3.x.',
	'CAT_USERGROUP'						=> 'Средства пользователей и групп',
	'CAT_USERGROUP_EXPLAIN'				=> 'Средства пользователей и групп могут быть использованы для управления пользователями и группами, такими способами, которые не доступны в стандартной установке phpBB 3.2.x/3.3.x.',
	'CONFIG_NOT_FOUND'					=> 'Не загружен файл конфигурации STK. Проверьте установку STK.',

	'CONFIG_VERSION'					=> 'Номер версии в Базе данных',
	'CONSTANT_VERSION'					=> 'Номер версии в файле /includes/constants.php',
	...
	'REQUEST_PHPBB_VERSION_EXPLAIN'		=> 'Инструментарий поддержки не смог правильно определить версию вашей конференции из-за различия номера версии в базе данных и файле /includes/constants.php<br />Это означает, что файлы и версия форума несовместимы, скорее всего, из-за неполного или неправильного обновления.<br />Выберите номер фактической версии из представленного ниже списка.<br />Посетите <a href="https://www.phpbbguru.net/community/viewforum.php?f=74">форум поддержки</a> чтобы получить конкретную помощь в решении данной проблемы.',
	...
	'STK_INCOMPATIBLE'					=> 'Эта версия STK для phpBB версии 3.2.x/3.3.x, в то время как ваша версия %1$s',
