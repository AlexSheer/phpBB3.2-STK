...
/**
* phpBB 3.2.10 data file
*/
class datafile_3_2_10
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bots changes  3.2.9 ->  3.2.10
	);

	/**
	* @var Array  3.2.10 config data
	*/
	var $config = array(
		...
		'img_strip_metadata'				=> array('config_value' => '0', 'is_dynamic' => '0'),
		'img_quality'						=> array('config_value' => '85', 'is_dynamic' => '0'),
		'queue_trigger_posts'				=> array('config_value' => '3', 'is_dynamic' => '0'),
	);

	/**
	* @var Array Config entries that were removed by the  3.2.9 update
	*/
	var $removed_config = array(
		// No config entries removed  3.2.9 ->  3.2.10
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.2.9 -> 3.2.10
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes  3.2.9 ->  3.2.10
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes  3.2.9 ->  3.2.10
	);
	...
	*/
	var $extensions = array(
		// No extension changes  3.2.9 ->  3.2.10
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes  3.2.9 ->  3.2.10
	);

	var $module_extras = array(
		// No Module extra changes  3.2.9 ->  3.2.10
	);

	var $module_categories_basenames = array(
		// No Categories basenames changes  3.2.9 ->  3.2.10
	);
	...
	*/
	var $groups = array(
		// No Group changes  3.2.9 ->  3.2.10
	);
	/**
	* @var Array All default report reasons
	*/
	var $report_reasons = array(
		// No reason changes  3.2.9 ->  3.2.10
	);

	var $acp_modules = array(
		// No ACP modules changes  3.2.9 ->  3.2.10
	);
	...
	*/
	...
	{
		// No schema changes  3.2.9 ->  3.2.10
	}
}
