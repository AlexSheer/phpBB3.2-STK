...
/**
* phpBB 3.2.5 data file
*/
class datafile_3_2_5
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bots changes 3.2.4 -> 3.2.5
	);

	/**
	* @var Array 3.2.5 config data
	*/
	var $config = array(
		// No config changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.2.4 -> 3.2.5
	);

	var $module_extras = array(
		// No Module extra changes 3.2.4 -> 3.2.5
	);

	var $module_categories_basenames = array(
		// No Categories basenames changes 3.2.4 -> 3.2.5
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.2.4 -> 3.2.5
	);
	/**
	* @var Array All default report reasons
	*/
	var $report_reasons = array(
		// No reason changes 3.2.4 -> 3.2.5
	);

	var $acp_modules = array(
		// No ACP modules changes 3.2.4 -> 3.2.5
	);
